defmodule FluxonUIFirstWeb.TodoLiveTest do
  use FluxonUIFirstWeb.ConnCase

  import Phoenix.LiveViewTest
  import FluxonUIFirst.TodosFixtures

  @create_attrs %{description: "some description", due: "2025-10-14"}
  @update_attrs %{description: "some updated description", due: "2025-10-15"}
