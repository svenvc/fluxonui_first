defmodule FluxonUIFirst.Todos do
  @moduledoc """
  The Todos context.
  """
  ...
  def subscribe_todos(%Scope{} = scope) do
    ...
    Phoenix.PubSub.subscribe(FluxonUIFirst.PubSub, "user:#{key}:todos")
  end

  defp broadcast_todo(%Scope{} = scope, message) do
    key = scope.user.id

    Phoenix.PubSub.broadcast(FluxonUIFirst.PubSub, "user:#{key}:todos", message)
  end
